...
import { confirmSportCore } from "@/lib/sport/core";
import { todayISO } from "@/lib/dates";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

/** "Yes, I did it" for a finished sport event on the home dashboard. */
export async function POST(req: NextRequest) {
  ...
  await confirmSportCore(eventId, authed.device.person.id, dateISO);
