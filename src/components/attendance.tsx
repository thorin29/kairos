...
const HEAD = "M12 3a3 3 0 1 0 0 6a3 3 0 1 0 0 -6z";
const BODY =
  "M9 10h6a4 4 0 0 1 4 4v2.6a3.9 3.9 0 0 1-3.9 3.9H8.9A3.9 3.9 0 0 1 5 16.6V14a4 4 0 0 1 4-4z";
const CHECK = "M11.2 16.6l-1.9-1.9 1-1 .9.9 2.3-2.3 1 1z";
const CROSS =
  "M12 13.9l1.6-1.6 1 1-1.6 1.6 1.6 1.6-1 1-1.6-1.6-1.6 1.6-1-1 1.6-1.6-1.6-1.6 1-1z";
const QUESTION =
  "M12 12.2c-1.1 0-2 .7-2.2 1.6l1.2.3c.1-.5.5-.7 1-.7.5 0 .9.3.9.7 0 .4-.3.6-.7.9-.6.4-.9.8-.9 1.5h1.2c0-.4.1-.5.6-.9.5-.4.9-.8.9-1.6 0-1-.9-1.8-2-1.8zM11.4 17h1.2v1.2h-1.2z";
