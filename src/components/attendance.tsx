...
const HEAD = "M12 1.5a3 3 0 1 0 0 6a3 3 0 1 0 0 -6z";
const BODY =
  "M9 9h6a4 4 0 0 1 4 4v10.5H5V13a4 4 0 0 1 4-4z";
const CHECK = "M11.2 18.1l-1.9-1.9 1-1 .9.9 2.3-2.3 1 1z";
const CROSS =
  "M12 15.4l1.6-1.6 1 1-1.6 1.6 1.6 1.6-1 1-1.6-1.6-1.6 1.6-1-1 1.6-1.6-1.6-1.6 1-1z";
const QUESTION =
  "M12 13.7c-1.1 0-2 .7-2.2 1.6l1.2.3c.1-.5.5-.7 1-.7.5 0 .9.3.9.7 0 .4-.3.6-.7.9-.6.4-.9.8-.9 1.5h1.2c0-.4.1-.5.6-.9.5-.4.9-.8.9-1.6 0-1-.9-1.8-2-1.8zM11.4 18.5h1.2v1.2h-1.2z";
...
export function AttendeeList({
  ...
  return (
    <div className={`flex flex-col gap-0.5 ${align === "end" ? "items-end" : "items-start"}`}>
      {attendees.map((a, i) => (
        <span key={i} className="flex items-baseline gap-1 text-xs text-muted">
